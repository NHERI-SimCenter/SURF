...
rst_prolog = """
.. |appName| replace:: *SURF*
.. |s3harkName| replace:: *SURF*
.. |surfName| replace:: *SURF*
.. |full tool name| replace:: Spatial Uncertainty Research Framework
.. |short tool name| replace:: SURF
.. |short tool id| replace:: SURF
.. |tool github link| replace:: `SURF Github page`_
.. _s3hark Github page: https://github.com/NHERI-SimCenter/SURF
.. |tool version| replace:: 0.2.4.2
